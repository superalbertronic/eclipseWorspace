...
public class MenuBorrar {
	public static void main(String[] args) {
		try {
			...
			//no a̱ade, pisa el fichero con los datos que se metan si se ejecuta de nuevo
		            ...
		            switch (opcion) {
		                case "A":
		                    ...
		                    if (!carpeta.exists()) {
		                        ...
		                        BufferedWriter bw = new BufferedWriter(new FileWriter(ruta+nombreCarpeta+"\\"+nombreCarpeta+".txt"));
