...
public class Main {
	public static void main(String[] args) {
        ...
        try {
            VentasController controller = new VentasController(dbURL, dbUser, dbPassword); // Crea una instancia del controlador
            controller.mostrarVentas(); // Llama al método del controlador para mostrar los clientes
