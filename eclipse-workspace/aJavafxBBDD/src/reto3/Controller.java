...
public class Controller {
	...
	private void mostrarRegistros() {
		...
		correoColumn.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getCorreo_electronico()));
		...
		fechaColumn.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getFecha_inscripcion()));
	...
	private void agregarEstudiante() {
			...
			String mensaje = "Estudiante añadido:\n" + "Nombre: " + nombre + "\n" + "Correo: " + correo_electronico + "\n"
					+ "Teléfono: " + telefono + "\n" + "Curso: " + curso + "Fecha Inscripción: " + fecha_inscripcion;
			...
			alert.setContentText(
					"Has dejado algún campo sin rellenar");
			alert.showAndWait();
