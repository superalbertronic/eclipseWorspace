...
public class MayorMenor {
    ...
    //ejemplo de metodo sin argumentos, que no devuleve nada
    public  int edad() {
    	// ejemplo instanciando
    	//MayorMenor prueba=new MayorMenor();
    	int eda=calcularMenor(12,20, 30);
    ...
    public static void main(String[] ar) {
        ...
        System.out.println(maymen.edad());
    }
}