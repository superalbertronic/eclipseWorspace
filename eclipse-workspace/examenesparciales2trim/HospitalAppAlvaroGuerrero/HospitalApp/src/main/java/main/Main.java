			...
			case 2:
				do {
					...
					case 2:
						...
						break;
					case 3:
						VerRegistros.mostrarTodosLosMedicos();
						break;
					case 4:
						System.out.println("Dime el id del médico a borrar");
						byte idPaciente2 = Byte.parseByte(sc.nextLine());
						EliminarRegistro.borrarMedico(idPaciente2);
						break;
					case 5:
