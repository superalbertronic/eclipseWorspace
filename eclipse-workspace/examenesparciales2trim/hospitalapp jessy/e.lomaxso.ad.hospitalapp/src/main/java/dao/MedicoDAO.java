...
public class MedicoDAO implements PlantillaDAO {
	...
	public void actualizarRegistro(int id, String campo, String valor) {
		...
		if (isInt(valor)) {
			...
			valorNum = x;
			updateHql = "UPDATE Medico SET " + campo + " = '" + valorNum + "' WHERE id = " + id;
		} else {
			updateHql = "UPDATE Medico SET " + campo + " = '" + valor + "' WHERE id = " + id;
		} // else
