...
public class Formulario extends JFrame {
		...
		botonCargarCurriculum.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (seleccion == JFileChooser.APPROVE_OPTION) {
					...
					JOptionPane.showMessageDialog(Formulario.this, "Curriculum cargado: " + archivoSeleccionado.getName(),
	...
	private void mostrarVentanaAgradecimiento() {
		JDialog dialogoAgradecimiento = new JDialog(Formulario.this, "Agradecimiento", true);
		...
		dialogoAgradecimiento.setLocationRelativeTo(Formulario.this);
