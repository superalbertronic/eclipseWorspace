...
public class PruebaSimulacro extends JFrame{
	...
	public PruebaSimulacro() {
		...
		comboBox_ocupacion.setModel(new DefaultComboBoxModel(new String[] {"Desempleado", "Trabajador por cuenta propia", "trabajador por cuenta ajena"}));
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Sin estudios", "Grado medio", "Grado superior", "Licenciado o grado"}));
